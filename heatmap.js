...
const BODY_REGIONS = {
    frontBackRegions: {
        ...
        leftUpperArm: { x: 20, y: 105, width: 40, height: 70 },
        rightUpperArm: { x: 130, y: 105, width: 40, height: 70 },
        leftElbow: { x: 20, y: 175, width: 30, height: 25 },
        rightElbow: { x: 130, y: 175, width: 30, height: 25 },
        leftForearm: { x: 20, y: 200, width: 40, height: 45 },
        rightForearm: { x: 130, y: 200, width: 40, height: 45 },
        leftWrist: { x: 20, y: 245, width: 30, height: 25 },
        rightWrist: { x: 130, y: 245, width: 30, height: 25 },
        leftHand: { x: 20, y: 270, width: 35, height: 30 },
        rightHand: { x: 130, y: 270, width: 35, height: 30 },
        pelvis: { x: 70, y: 185, width: 50, height: 40 },
        hips: { x: 70, y: 225, width: 50, height: 35 },
        thighs: { x: 65, y: 260, width: 60, height: 50 },
        knees: { x: 65, y: 310, width: 60, height: 20 },
        shins: { x: 65, y: 330, width: 60, height: 45 },
        ankle: { x: 65, y: 375, width: 50, height: 20 },
        feet: { x: 65, y: 395, width: 50, height: 25 }
    },
    sideRegions: {
