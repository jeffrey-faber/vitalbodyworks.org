...
const BODY_REGIONS = {
    frontBackRegions: {
        ...
        leftUpperArm: { x: 50, y: 105, width: 30, height: 70 },
        rightUpperArm: { x: 120, y: 105, width: 30, height: 70 },
        leftElbow: { x: 50, y: 175, width: 30, height: 25 },
        rightElbow: { x: 120, y: 175, width: 30, height: 25 },
        leftForearm: { x: 50, y: 200, width: 30, height: 45 },
        rightForearm: { x: 120, y: 200, width: 30, height: 45 },
        leftWrist: { x: 50, y: 245, width: 30, height: 25 },
        rightWrist: { x: 120, y: 245, width: 30, height: 25 },
        leftHand: { x: 50, y: 270, width: 30, height: 30 },
        rightHand: { x: 120, y: 270, width: 30, height: 30 },
        ...
        feet: { x: 50, y: 395, width: 90, height: 25 }
    }    
    ,    
    sideRegions: {
