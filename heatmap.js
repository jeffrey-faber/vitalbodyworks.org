...
const BODY_REGIONS = {
    frontBackRegions:{
        ...
        shoulders: { x: 55, y: 85, width: 90, height: 20 },
        pectoralisMuscles: { x: 65, y: 105, width: 70, height: 35 },
        abdomen: { x: 70, y: 140, width: 60, height: 60 },
        leftUpperArm: { x: 35, y: 105, width: 30, height: 70 },
        rightUpperArm: { x: 135, y: 105, width: 30, height: 70 },
        leftElbow: { x: 30, y: 175, width: 35, height: 20 },
        rightElbow: { x: 135, y: 175, width: 35, height: 20 },
        leftForearm: { x: 30, y: 195, width: 35, height: 50 },
        rightForearm: { x: 135, y: 195, width: 35, height: 50 },
        leftWrist: { x: 30, y: 245, width: 35, height: 15 },
        rightWrist: { x: 135, y: 245, width: 35, height: 15 },
        leftHand: { x: 30, y: 260, width: 35, height: 30 },
        rightHand: { x: 135, y: 260, width: 35, height: 30 },
        pelvis: { x: 65, y: 200, width: 70, height: 30 },
        hips: { x: 60, y: 230, width: 80, height: 30 },
        thighs: { x: 60, y: 260, width: 80, height: 50 },
        knees: { x: 60, y: 310, width: 80, height: 20 },
        shins: { x: 60, y: 330, width: 80, height: 45 },
        ankle: { x: 60, y: 375, width: 80, height: 20 },
        feet: { x: 60, y: 395, width: 80, height: 25 }
      },    
    sideRegions: {
