...
const BODY_REGIONS = {
    frontBackRegions: {
        ...
        upperArm: { x: 20, y: 105, width: 40, height: 70 },
        elbow: { x: 20, y: 175, width: 30, height: 25 },
        forearm: { x: 20, y: 200, width: 40, height: 45 },
        wrist: { x: 20, y: 245, width: 30, height: 25 },
        hand: { x: 20, y: 270, width: 35, height: 30 },
