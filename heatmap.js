...
const BODY_REGIONS = {
  ...
  face: { x: 75, y: 35, width: 50, height: 40 },
  neck: { x: 80, y: 75, width: 40, height: 20 },
  shoulders: { x: 55, y: 95, width: 90, height: 20 },
  upperChest: { x: 65, y: 115, width: 70, height: 25 },
  lowerChest: { x: 65, y: 140, width: 70, height: 35 },
  abdomen: { x: 70, y: 175, width: 60, height: 50 },
  ...
  leftHand: { x: 30, y: 295, width: 35, height: 30 },
  rightHand: { x: 135, y: 295, width: 35, height: 30 },
  pelvis: { x: 65, y: 225, width: 70, height: 40 },
  hips: { x: 60, y: 265, width: 80, height: 30 },
  thighs: { x: 60, y: 295, width: 80, height: 50 },
  knees: { x: 60, y: 345, width: 80, height: 20 },
  shins: { x: 60, y: 365, width: 80, height: 40 },
  ankles: { x: 60, y: 405, width: 80, height: 20 },
