...
const BODY_REGIONS = {
    frontBackRegions: {
        ...
        leftUpperArm: { x: 40, y: 105, width: 35, height: 70 },
        rightUpperArm: { x: 110, y: 105, width: 35, height: 70 },
        leftElbow: { x: 40, y: 175, width: 30, height: 25 },
        rightElbow: { x: 110, y: 175, width: 30, height: 25 },
        leftForearm: { x: 40, y: 200, width: 30, height: 45 },
        rightForearm: { x: 110, y: 200, width: 30, height: 45 },
        leftWrist: { x: 40, y: 245, width: 30, height: 25 },
        rightWrist: { x: 110, y: 245, width: 30, height: 25 },
        leftHand: { x: 40, y: 270, width: 30, height: 30 },
        rightHand: { x: 110, y: 270, width: 30, height: 30 },
