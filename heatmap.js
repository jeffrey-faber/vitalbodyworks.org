...
const BODY_REGIONS = {
    frontBackRegions:{
        ...
        leftWrist: { x: 20, y: 295, width: 35, height: 15 },
        rightWrist: { x: 145, y: 295, width: 35, height: 15 },
        leftHand: { x: 20, y: 310, width: 35, height: 30 },
        rightHand: { x: 145, y: 310, width: 35, height: 30 },
