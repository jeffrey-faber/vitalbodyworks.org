...
const BODY_REGIONS = {
    frontBackRegions:{
        ...
        leftWrist: { x: 1, y: 295, width: 35, height: 15 },
        rightWrist: { x: 165, y: 295, width: 35, height: 15 },
        leftHand: { x: 1, y: 310, width: 35, height: 30 },
        rightHand: { x: 165, y: 310, width: 35, height: 30 },
